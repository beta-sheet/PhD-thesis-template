...
\usepackage{amsmath,amsthm,bm} % Math packages
...
\DeclareCaptionFormat{myformat}{#1#2#3{\color{PineGreen}\hrulefill}}
...
\hypersetup{%
  ...
  colorlinks=true, linktocpage=true,linkcolor=blue,
...
\hypersetup{
  ...
  urlcolor=ProcessBlue, linkcolor=ProcessBlue, citecolor=ProcessBlue, %pagecolor=Black,%
}
...
\titleformat{\chapter}[display]%
  {\relax}{\vspace*{\baselineskip}\makebox[\linewidth][c]{\color{NavyBlue}\chapterNumber\thechapter}}{20pt}%
  {\centering\itshape\bfseries\huge}[\vspace*{.8\baselineskip}\titlerule]%
